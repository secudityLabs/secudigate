  ...
  return (
    <header className="sticky top-0 z-30 border-b border-line/60 bg-bg/70 backdrop-blur">
      <div className="max-w-6xl mx-auto px-5 h-14 flex items-center gap-3 sm:gap-6">
        <Link to="/" className="flex items-center gap-1.5 font-semibold tracking-tight shrink-0">
          <img
            ...
            draggable={false}
          />
          <span className="hidden sm:inline">Secudigate</span>
        </Link>
      ...
      {menuOpen && (
        <div className="sm:hidden border-t border-line/60 bg-bg/95 backdrop-blur">
          <nav className="max-w-6xl mx-auto px-5 py-2 flex flex-col text-sm">
            ...
            <div className="px-3 py-3 mt-1 border-t border-line/60 flex items-center justify-between">
              <span className="text-ink-dim">Theme</span>
              <ThemeToggle />
            </div>
          </nav>
        </div>
